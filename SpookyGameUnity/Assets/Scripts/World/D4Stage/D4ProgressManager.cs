...
namespace SpookyGame.D4Scene
{
    /// <summary>
    /// D4 场景管理器
    /// 管理 D4 场景的进度和转场
    /// </summary>
    public class D4ProgressManager : MonoBehaviour
    {
        [Header("Scene Transition")]
        [Tooltip("对话结束后切换的关卡")]
        [SerializeField] private string nextStageId = "D5";
        
        [Tooltip("场景切换提示文字")]
        [SerializeField] private string stageChangeStr = "Day 5";
